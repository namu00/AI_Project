...
def img_augment(x_train, t_train, batch_size):
    ...
    for i in range(batch_size):
        img = x_train[i][0] * 255                               #Normalize 해제
        ...
        img = img[np.newaxis,np.newaxis, :]             #기존 학습데이터셋에 추가하기 위한 빈 N,C채널 생성, H/W --> N/C/H/W
...
if __name__ == "__main__": #함수 테스트
    (x_train, t_train), (x_test, t_test) = load_fashionMNIST(
